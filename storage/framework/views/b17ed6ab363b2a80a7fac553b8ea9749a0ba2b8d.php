...
<section class="headerbg"
    ...
    <div class="container text-left">
        ...
        <p class="mb-0"><a href="<?php echo e(URL::to('/')); ?>"><?php echo e(Helper::translation(1913,$translate)); ?></a> <span class="split">&gt;</span>
            <span><?php echo e(Helper::translation(2110,$translate)); ?></span></p>
    </div>
</section>
<main role="main">
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-12" align="right">
                <a href="<?php echo e(URL::to('/my-purchase')); ?>"
                   class="btn button-color">&lt; <?php echo e(Helper::translation(2088,$translate)); ?></a><a
                    href="<?php echo e(url('/invoice')); ?>/<?php echo e($purchase->purchase_token); ?>" class="btn btn-danger ml-1"><i
            ...
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    <div class="col-sm-3">
                        ...
                        <?php if($purchase->payment_status == 'completed'): ?> <span
                            class="badge badge-success"><?php echo e(Helper::translation(2084,$translate)); ?></span> <?php else: ?> <span
                            class="badge badge-danger"><?php echo e(Helper::translation(2085,$translate)); ?></span> <?php endif; ?>
                    </div>
                </div>
                    ...
                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                        ...
                        <?php $__currentLoopData = $product['view']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                    ...
                                    <a href="<?php echo e(url('/product')); ?>/<?php echo e($product->product_slug); ?>">
                                        <?php if($product->product_image != ''): ?>
                                            <img
                                                ...
                                                class="img-thumb" alt="<?php echo e($product->product_name); ?>"/><?php else: ?> <img
                                            src="<?php echo e(url('/')); ?>/public/img/no-image.jpg" class="img-thumb"
                                            alt="<?php echo e($product->product_name); ?>"/>  <?php endif; ?>
                                    </a>
                                </td>
                                <td><?php echo e($product->quantity); ?>

                                    X <?php echo e($allsettings->site_currency_symbol); ?><?php echo e($product->price); ?></td>
                                    ...
                                    <?php if($product->order_status == 'completed'): ?>
                                        <?php if($product->payment_status != $payment_status_buyer or $product->payment_status == $payment_status_vendor): ?>
                                            <a href="javascript:void(0);" class="badge badge-success"
                                               data-toggle="modal" data-target="#sem-rate-<?php echo e($product->ord_id); ?>"><i
                                                    class="fa fa-star"></i> <?php echo e(Helper::translation(2114,$translate)); ?>
                                        ...
                                        <?php if($product->product_type == 'digital'): ?>
                                            <?php if($product->payment_status != $payment_status_buyer or $product->payment_status == $payment_status_vendor): ?>
                                                <?php if($allsettings->site_s3_storage == 1): ?>
                                                    <br/><a href="<?php echo e($fileurl); ?>" class="badge badge-primary"
                                                            download><i
                                                            class="fa fa-download"></i> <?php echo e(Helper::translation(2116,$translate)); ?>

                                                    </a>
                                                <?php else: ?>
                                                    <br/><a
                                                        href="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($product->product_file); ?>"
                                                        class="badge badge-primary" download><i
                                                            class="fa fa-download"></i> <?php echo e(Helper::translation(2116,$translate)); ?>
                                    ...
                                    <?php if($product->product_type == 'physical'): ?>
                                        <?php if($product->payment_status != $payment_status_buyer): ?>
                                            <a href="javascript:void(0);" class="btn btn-danger btn-sm"
                                               data-toggle="modal"
                                               data-target="#sem-track-<?php echo e($product->ord_id); ?>"><?php echo e(Helper::translation(2098,$translate)); ?></a>
                                        <?php else: ?>
                                            <span>---</span>
                                        <?php endif; ?>
                                    <?php else: ?>
                                ...
                                <td>
                                    <?php if($product->payment_status != $payment_status_buyer or $product->payment_status == $payment_status_vendor): ?>
                                        <a href="<?php echo e(url('/conversation-to-vendor')); ?>/<?php echo e($product->username); ?>/<?php echo e($encrypter->encrypt($product->ord_id)); ?>"
                                           class="btn btn-primary btn-sm"><?php echo e(Helper::translation(2915,$translate)); ?></a>
                                    <?php else: ?>
                                        <span>---</span>
                                    <?php endif; ?>
                                </td>
                            ...
                            <div class="modal fade seminor-login-modal" data-backdrop="static"
                                 id="sem-track-<?php echo e($product->ord_id); ?>">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="card-body">
                                                <h6><?php echo e(Helper::translation(2076,$translate)); ?>

                                                    : <?php echo e($product->ord_id); ?></h6>
                                                <article class="card">
                                                    <div class="card-body row">
                                                        <div class="col">
                                                            <strong><?php echo e(Helper::translation(2094,$translate)); ?>:</strong>
                                                            <br><?php echo e($delivery_date); ?></div>
                                                        <div class="col">
                                                            <strong><?php echo e(Helper::translation(1915,$translate)); ?>:</strong>
                                                            <br> Order has been <?php echo e($product->order_tracking); ?></div>
                                                        <div class="col">
                                                            <strong><?php echo e(Helper::translation(2117,$translate)); ?>:</strong>
                                                            <br> <?php echo e($product->ord_id); ?> </div>
                                                    </div>
                                                </article>
                                                <div class="track">
                                                    <?php if($product->order_tracking == $track_placed): ?>
                                                        <div class="step active"><span class="icon"> <i
                                                                ...
                                                                class="text"><?php echo e(Helper::translation(2118,$translate)); ?></span>
                                                        </div>
                                                        <div class="step"><span class="icon"> <i
                                                                    class="fa fa-square"></i> </span> <span
                                                                class="text"><?php echo e(Helper::translation(2119,$translate)); ?></span>
                                                        </div>
                                                        <div class="step"><span class="icon"> <i
                                                                    class="fa fa-truck"></i> </span> <span
                                                                class="text"><?php echo e(Helper::translation(2120,$translate)); ?></span>
                                                        </div>
                                                        <div class="step"><span class="icon"> <i
                                                                    class="fa fa-handshake-o"></i> </span> <span
                                                                class="text"><?php echo e(Helper::translation(2121,$translate)); ?></span>
                                                        </div>
                                                    <?php endif; ?>
                            ...
                            <div class="modal fade seminor-login-modal" data-backdrop="static"
                                 id="sem-rate-<?php echo e($product->ord_id); ?>">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <?php if($product->product_image != ''): ?>
                                                        <img
                                                            src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($product->product_image); ?>"
                                                            class="refund-img" alt="<?php echo e($product->product_name); ?>"/><?php else: ?>
                                                ...
                                                <div class="col-md-6">
                                                    <form action="<?php echo e(route('rating')); ?>" class="setting_form"
                                                          method="post" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>

                                                        <div class="form-group">
                                                            <label
                                                                for="email"><?php echo e(Helper::translation(2122,$translate)); ?></label><br/>
                                                            <div>
                                                        ...
                                                        <div class="form-group">
                                                            <label
                                                                for="pwd"><?php echo e(Helper::translation(2123,$translate)); ?></label>
                                                        ...
                                                        <input type="hidden" name="order_id"
                                                               value="<?php echo e($product->ord_id); ?>">
                                                        <button type="submit"
                                                                class="btn button-color"><?php echo e(Helper::translation(1919,$translate)); ?></button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="modal fade seminor-login-modal" data-backdrop="static"
                                 id="sem-login-<?php echo e($product->ord_id); ?>">
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <form action="<?php echo e(route('refund-request')); ?>" class="setting_form"
                                                          method="post" enctype="multipart/form-data">
                                                        <?php echo e(csrf_field()); ?>
                                                        ...
                                                        <input type="hidden" name="product_slug"
                                                               value="<?php echo e($product->product_slug); ?>">
                                                        <input type="hidden" name="purchase_token"
                                                               value="<?php echo e($product->purchase_token); ?>">
                                                        <input type="hidden" name="order_id"
                                                               value="<?php echo e($product->ord_id); ?>">
                                                        <input type="hidden" name="payment_date"
                                                               value="<?php echo e($purchase->payment_date); ?>">
                                                        <input type="hidden" name="buyer_id"
                                                               value="<?php echo e(Auth::user()->id); ?>">
                                                        <input type="hidden" name="vendor_id"
                                                               value="<?php echo e($product->product_user_id); ?>">
                                                        <input type="hidden" name="payment"
                                                               value="<?php echo e($product->subtotal); ?>">
                                                        <input type="hidden" name="payment_type"
                                                               value="<?php echo e($product->payment_type); ?>">
                                                        <div class="form-group">
                                                            <label
                                                                for="email"><?php echo e(Helper::translation(2125,$translate)); ?></label>
                                                            <input type="text" class="form-control" name="reason"
                                                                   required="required">
                                                        </div>
                                                        <div class="form-group">
                                                            <label
                                                                for="pwd"><?php echo e(Helper::translation(2126,$translate)); ?></label>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ecomm_multi\resources\views/my-purchase-details.blade.php ENDPATH**/ ?>