...
<section class="headerbg"
    ...
    <div class="container text-left">
        ...
        <p class="mb-0"><a href="<?php echo e(URL::to('/')); ?>"><?php echo e(Helper::translation(1913,$translate)); ?></a> <span class="split">&gt;</span>
            <a href="<?php echo e(URL::to('/shop')); ?>"><?php echo e(Helper::translation(2040,$translate)); ?></a> <span
                class="split">&gt;</span><span> <?php echo e($shop->product_name); ?></span></p>
    </div>
</section>
<main role="main">
    <div class="container">
        ...
        <div class="row bg-white border-0 mt-3 mb-3">
                            ...
                            <?php if($imagecount != 0): ?>
                                <?php $__currentLoopData = $shop->productimages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $images): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li data-thumb="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($images->product_image); ?>">
                                        <a href="">
                                            <img
                                                src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($images->product_image); ?>"/>
                                        </a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
            ...
            <div class="col-md-6 mt-3 mb-3">
                <form action="<?php echo e(route('cart')); ?>" class="cart_form" id="cart_form" method="post"
                ...
                <span>( <?php echo e($getreview); ?> <?php echo e(Helper::translation(2144,$translate).' )'); ?></span>
                    ...
                    <?php if($shop->product_type != 'digital'): ?>
                        <div class="mt-2"><?php echo e(Helper::translation(2062,$translate)); ?> : <?php if($shop->product_stock != 0): ?>
                                <span class="theme-color"><?php echo e(Helper::translation(2063,$translate)); ?> (<?php echo e($shop->product_stock); ?>)</span><?php else: ?>
                                <span class="red-color"><?php echo e(Helper::translation(2064,$translate)); ?> (<?php echo e($shop->product_stock); ?>)</span><?php endif; ?>
                        </div>
                    <?php endif; ?>
            ...
            @if($shop->product_price != 0)<span @if($shop->product_offer_price != 0) class="fs16 offer-price red-color" @else class="fs32 display_result" @endif>{{ $allsettings->site_currency_symbol }}{{ $shop->product_price+$attri_value }}</span>@endif @if($shop->product_offer_price != 0)<span class="fs32 display_result">{{ $allsettings->site_currency_symbol }}{{ $shop->product_offer_price+$attri_value }}</span>@endif</div><?php */
                    ...
                    <div class="mt-5" id="start">
                        <?php if($shop->product_offer_price != 0): ?><span
                            class="fs32 display_result"><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($shop->product_offer_price); ?></span><?php else: ?>
                            <span
                                class="fs32 display_result"><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($shop->product_price); ?></span><?php endif; ?>
                    </div>
                    ...
                    <div class="qty mt-5 mb-5">
                        <?php if($shop->product_type != 'digital'): ?>
                            <span>
                                              ...
                                              <input type="number" name="qty" class="form-control qty_box" id="qty"
                                                     min="0.5" step="0.5"
                                                     data-bvalidator="required,min[0.5],max[<?php echo e($shop->product_stock); ?>]"
                                                     value="0.5">
                                           </span>
                        <?php else: ?>
                            ...
                            <?php if(count($attributer['display']) != 0): ?>
                                ...
                                <?php $__currentLoopData = $attributer['display']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span>
                                        ...
                                        <span><?php echo e($product_value->attribute_value); ?></span>
                    ...
                    <?php if($shop->product_type != 'digital'): ?>
                        <div class="mt-2"><?php echo e(Helper::translation(2094,$translate)); ?> :
                            <span><?php echo e($shop->product_estimate_time); ?> <?php echo e(Helper::translation(2071,$translate)); ?></span>
                        </div><?php endif; ?>
                    <?php if(Auth::guest()): ?>
                        <div class="mt-3">
                            ...
                            <a href="<?php echo e(URL::to('/login')); ?>"
                               class="btn button-color float-left"><?php echo e(Helper::translation(2067,$translate)); ?></a>
                        </div>
                    <?php else: ?>
                        <?php if($shop->product_stock != 0): ?>
                            <?php if($shop->user_id != Auth::user()->id): ?>
                                <?php if($shop->product_type != 'external'): ?>
                                    <div class="mt-3">
                                        <?php if($shop->product_video_url != ''): ?>
                                            <a class="bla-2 btn btn-danger float-left mr-1"
                                               href="<?php echo e($shop->product_video_url); ?>"><i
                                                    class="fa fa-file-video-o"></i> <?php echo e(Helper::translation(2147,$translate)); ?>

                                            </a>
                                        <?php endif; ?>
                                        <button type="submit"
                                                class="btn button-color float-left"><?php echo e(Helper::translation(2067,$translate)); ?></button>
                                    </div>
                                <?php else: ?>
                                    <div class="mt-3">
                                        <?php if($shop->product_video_url != ''): ?>
                    ...
                    <?php if(!empty($shop->product_offer_price)): ?>
                        <input type="hidden" name="price" id="price"
                               value="<?php echo e(base64_encode($shop->product_offer_price+$attri_value)); ?>">
                    <?php else: ?>
                        <input type="hidden" name="price" id="price"
                               value="<?php echo e(base64_encode($shop->product_price+$attri_value)); ?>">
                    <?php endif; ?>
                    ...
                    <ul class="social-icons">
                        <li>
                            <a class="share-button" data-share-url="<?php echo e(URL::to('/product')); ?>/<?php echo e($shop->product_slug); ?>"
                               ...
                               data-share-title="<?php echo e($shop->product_name); ?>"
                               data-share-via="<?php echo e($allsettings->site_title); ?>" data-share-tags=""
                               data-share-media="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($shop->product_image); ?>"
                        ...
                        <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="two-tab" data-toggle="tab" href="#two" role="tab"
                                   aria-controls="Two"
                                   aria-selected="false"><?php echo e(Helper::translation(2151,$translate)); ?></a>
                            </li>
                                            ...
                                            <div class="avatar">
                                                <a href="<?php echo e(URL::to('/user')); ?>/<?php echo e($rating->username); ?>">
                                                    <?php if($rating->user_photo!=''): ?>
                                                        <img
                                                            src="<?php echo e(url('/')); ?>/public/storage/users/<?php echo e($rating->user_photo); ?>"
                                                            alt="<?php echo e($rating->username); ?>" class="media-object">
                                                    <?php else: ?>
                                                        <img src="<?php echo e(url('/')); ?>/public/img/no-user.png"
                                                             alt="<?php echo e($rating->username); ?>" class="media-object">
                                                    <?php endif; ?>
                                                </a>
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-2 pb-2">
                                <div class="product-grid2">
                                    <div class="product-image2">
                                        <div class="product-hider">
                                            <a href="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($product->product_image); ?>"
                                               data-fancybox="quick-view-<?php echo e($product->product_token.$z); ?>"
                                               data-type="image" class="quickview">
                                                <i class="fa fa-eye"></i>
                                                <p><?php echo e(Helper::translation(2060,$translate)); ?>

                                                    <br/><?php echo e(Helper::translation(2061,$translate)); ?></p>
                                            </a>
                                            ...
                                            <div class="product-former">
                                                ...
                                                <div class="mt-3"><?php echo e(Helper::translation(2062,$translate)); ?>

                                                    : <?php if($product->product_stock != 0): ?><span class="theme-color"><?php echo e(Helper::translation(2063,$translate)); ?> (<?php echo e($product->product_stock); ?>)</span><?php else: ?>
                                                        <span class="red-color"><?php echo e(Helper::translation(2064,$translate)); ?> (<?php echo e($product->product_stock); ?>)</span><?php endif; ?>
                                                </div>
                                                <?php if($product->product_condition == 'new'){ $badg = "badge badge-warning"; } else { $badg = "badge badge-secondary"; } ?>
                                                <?php if($product->product_condition != ""): ?>
                                                    <div class="mt-2"><?php echo e(Helper::translation(1950,$translate)); ?> : <span
                                                            class="<?php echo e($badg); ?>"><?php echo e($product->product_condition); ?></span>
                                                    </div><?php endif; ?>
                                                <div class="mt-3"><?php if($product->product_price != 0): ?><span
                                                        <?php if($product->product_offer_price != 0): ?> class="fs16 offer-price red-color"
                                                        <?php else: ?> class="fs32" <?php endif; ?>><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($product->product_price); ?></span><?php endif; ?> <?php if($product->product_offer_price != 0): ?>
                                                        <span
                                                ...
                                                <p><a href="<?php echo e(URL::to('/product')); ?>/<?php echo e($product->product_slug); ?>"
                                                      class="btn button-color"><?php echo e(Helper::translation(2065,$translate)); ?></a>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="social">
                                            <?php if(Auth::guest()): ?>
                                                <li><a href="<?php echo e(url('/login')); ?>"
                                                       data-tip="<?php echo e(Helper::translation(2066,$translate)); ?>"><i
                                                            class="fa fa-shopping-bag"></i></a></li>
                                            <?php else: ?>
                                                <?php if(Auth::user()->id != $product->user_id): ?>
                                                    <li>
                                                        <a href="<?php echo e(url('/wishlist')); ?>/<?php echo e(Auth::user()->id); ?>/<?php echo e($product->product_token); ?>"
                                                           data-tip="<?php echo e(Helper::translation(2066,$translate)); ?>"><i
                                                                class="fa fa-shopping-bag"></i></a></li>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <li><a href="<?php echo e(URL::to('/product')); ?>/<?php echo e($product->product_slug); ?>"
                                                   data-tip="<?php echo e(Helper::translation(2067,$translate)); ?>"><i
                                                        class="fa fa-shopping-cart"></i></a></li>
                                        </ul>
                                        <a class="add-to-cart"
                                           href="<?php echo e(URL::to('/product')); ?>/<?php echo e($product->product_slug); ?>"><?php echo e(Helper::translation(2067,$translate)); ?></a>
                                    </div>
                                    <div class="product-content">
                                        ...
                                        <span
                                            class="price like"><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($product->product_price); ?></span>
                                    </div>
                                </div>
                            </div>
                            <?php $z++; ?>
