            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(3246,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                        ...
                        <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(3033,$translate)); ?> <span class="require">*</span></label>
                         <input id="page_slug" name="page_slug" type="text" class="form-control" data-bvalidator="required" value="<?php echo e($edit['page']->page_slug); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['page']->page_status == 1): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(1916,$translate)); ?></option>
                                                <option value="0" <?php if($edit['page']->page_status == 0): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(1917,$translate)); ?></option>
                                                </select>
                                            </div> 
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['page']->main_menu == 1): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(1942,$translate)); ?></option>
                                                <option value="0" <?php if($edit['page']->main_menu == 0): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(1943,$translate)); ?></option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['page']->footer_menu == 1): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(1942,$translate)); ?></option>
                                                <option value="0" <?php if($edit['page']->footer_menu == 0): ?> selected="selected" <?php endif; ?>><?php echo e(Helper::translation(1943,$translate)); ?></option>
                                                </select>
                                             </div>
                                            <div class="form-group">
...
</html><?php /**PATH C:\xampp\htdocs\ecomm_multi\resources\views/admin/edit-page.blade.php ENDPATH**/ ?>