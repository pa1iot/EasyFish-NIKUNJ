            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(3850,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="row">
                   <div class="col-md-12">
                      <div class="card">
                           ...
                           @else
                           <form action="{{ route('admin.edit-deliveryboy') }}" method="post" id="setting_form" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           @endif
                           <div class="col-md-6">
                           <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="user_address" name="user_address" class="form-control" data-bvalidator="required">{{ $edit['userdata']->user_address }}</textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="user_phone"
                                                   class="control-label mb-1">{{ Helper::translation(2002,$translate) }}</label>
                                            <input id="user_phone" name="user_phone" type="text" value="{{ $edit['userdata']->user_phone }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="postcode" name="postcode" type="text" value="{{ $edit['userdata']->postcode }}"
                                                   class="form-control" data-bvalidator="required" >
                                        </div>
