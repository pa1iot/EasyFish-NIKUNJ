                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            @else
                                <form action="{{ route('admin.edit-administrator') }}" method="post" id="setting_form"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="user_phone"
                                                            ...
                                                            <span class="require">*</span></label>
                                                        <input id="user_phone" name="user_phone"   value="{{ $edit['userdata']->user_phone }}" type="text" class="form-control"
                                                               data-bvalidator="required">
                                                    </div>
                                                    <input type="hidden" name="user_type" value="admin">
{{--                                                    <div class="form-group">--}}
{{--                                                        <label for="password"--}}
{{--                                                               class="control-label mb-1">{{ Helper::translation(2102,$translate) }}</label>--}}
...
{{--                                                        <div class="form-group">--}}
{{--                                                            <label for="earnings"--}}
{{--                                                                   class="control-label mb-1">{{ Helper::translation(2973,$translate) }}--}}
{{--                                                                ({{ $allsettings->site_currency_symbol }})</label>--}}
{{--                                                            <input id="earnings" name="earnings" type="text"--}}
{{--                                                                   class="form-control"--}}
{{--                                                                   value="{{ $edit['userdata']->earnings }}"--}}
{{--                                                                   data-bvalidator="min[0]">--}}
{{--                                                        </div>--}}
                                                    @endif
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" id="user_photo" name="user_photo"
                                                               ...
                                                               data-bvalidator-msg="{{ Helper::translation(1937,$translate) }}">@if($edit['userdata']->user_photo != '')
                                                            <img height="50"
                                                                 src="{{ url('/') }}/public/storage/users/{{ $edit['userdata']->user_photo }}"
                                                                 class="userphoto"/>@else <img height="50"
                                                                                               src="{{ url('/') }}/public/img/no-user.png"
                                                                                               class="userphoto"/>  @endif
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @foreach($permission as $key => $value)
                                                            <span><input type="checkbox" id="user_permission[]"
                                                                         name="user_permission[]" value="{{ $key }}"
                                                                         @if(in_array($key,$edituser)) checked @endif> {{ $value }}</span>
                                                            <br/>
                                                        @endforeach
                                                    </div>
                                                </div>
